export function SearchIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M9 17C13.4183 17 17 13.4183 17 9C17 4.58172 13.4183 1 9 1C4.58172 1 1 4.58172 1 9C1 13.4183 4.58172 17 9 17Z" stroke="#8F8B8B" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M18.9999 19L14.6499 14.65" stroke="#8F8B8B" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function InfoIcon() {
  return (
    <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M13.9531 10.2938L10.3749 10.7422L10.2468 11.336L10.9499 11.4656C11.4093 11.575 11.4999 11.7406 11.3999 12.1985L10.2468 17.6172C9.94368 19.0188 10.4109 19.6781 11.5093 19.6781C12.3609 19.6781 13.3499 19.2844 13.7984 18.7438L13.9359 18.0938C13.6234 18.3688 13.1671 18.4781 12.864 18.4781C12.4343 18.4781 12.278 18.1766 12.389 17.6453L13.9531 10.2938Z" fill="#FC830A" />
...
export function CaretIcon() {
  return (
    <svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M1 1L7 7L13 1" stroke="#8F8B8B" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}

export function RightCaretIcon() {
  return (
    <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M1 13L7 7L1 1" stroke="#3F3F3F" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
